...
class SiamCARTracker(SiameseTracker):
    def __init__(self, model, cfg):
        ...
        self.score_size = (cfg.INSTANCE_SIZE - cfg.EXEMPLAR_SIZE) // \
                        8+ 1 + 8
    ...
    def track(self, img, hp, ID):
        ...
        outputs, timelist, translist = self.model.track(x_crop, ID, self.timelist, self.translist)
        ...
        A = cfg.TRACK.PENALTY_K
        B = cfg.TRACK.WINDOW_INFLUENCE
        c = cfg.TRACK.LR
